...
var i18n_default = {
  ...
  DESTINATION,
  ERROR_COMMAND_CMD,
  ERROR_INVALID_DEPLOYMENT_CONFIGURATION,
  ERROR_USER_PASSWORD_PLAIN,
  ERROR_YO_NOT_INSTALLED,
  ERROR_INSTALL_FIORI_GENERATOR,
  FILE_CREATED,
  GENERATE_STANDALONE_INDEX_HTML,
  INDEX_EXISTS_NOT_OVERWRITING,
  INDEX_HTML_ADDED,
  INFO_CREATE_ARCHIVE,
  INFO_COMMAND_FAILED,
  INFO_DEPLOYMENT_SUCCESSFUL,
  INFO_DEPLOYMENT_FAILED,
  INFO_TEST_MODE,
  ERROR_NO_SYSTEM_IN_STORE,
  INFO_FILE_PATH_ADDED,
  INFO_LIVERELOAD_STARTED,
  ERROR_STARTING_LIVERELOAD,
  INFO_STARTING_DEPLOYMENT,
  INFO_STORE_DETAILS,
  INFO_USED_DESTINATION,
  INVALID_DATA,
  INVALID_ODATA_VERSION,
  ...
  PROXY_STARTED_FOR,
  SERVICE_KEYS_CONTENT_EMPTY,
  START_DEPLOYMENT,
  START_DEPLOYMENT_TESTMODE,
  SYSTEM_NAME_EMPTY,
  SYSTEM_NAME_IN_USE,
  TARGET,
  TRANSPORT_REQUEST,
  USE_IT_INSTEAD,
  USING_SYSTEM_WITH_SAME_URL_NO_CLIENT,
  USING_SYSTEM_FROM_STORE,
  WARNING_PACKAGE_IN_CUSTOMER_SPACE,
  ERROR_EXTRACT_API_KEY,
  ERROR_API_HUB_KEY,
  SSL_IGNORE_WARNING,
  SSL_PROXY_ERROR,
  NO_DEPLOY_CONFIG,
  ...
  INFO_STARTING_UNDEPLOYMENT,
  INFO_UNDEPLOYMENT_SUCCESSFUL,
  INFO_UNDEPLOYMENT_FAILED,
  START_UNDEPLOYMENT,
  USERNAME,
  PASSWORD,
  REQUIRE_CREDENTIAL,
  REQUIRE_CREDENTIAL_FLP,
  ERROR_NO_VSCODE_SETTINGS_FILE,
  INFO_SAML_NOT_SUPPORTED,
  INFO_RESPONSE_UNCERTAIN,
  VSCODE_SETTINGS_FILE_NOT_PARSEABLE,
  ERROR_EMPTY_USERNAME,
  ERROR_EMPTY_PASSWORD,
  OPERATION_ABORTED,
  ERROR_ACHIVE_FROM_EXTERNAL_FILEPATH,
  ERROR_ACHIVE_FROM_EXTERNAL_URL,
  NO_CAP,
  DEPLOYMENT_MSG,
  DEPLOYMENT_MANAGED_CF_URL,
  DEPLOYMENT_HELP,
  DEPLOYMENT_STANDALONE_CF_URL,
  ERROR_NO_UI5_FLEX_LAYER,
  ERROR_WRONG_UI5_FLEX_LAYER,
  ERROR_WRONG_MINUI5VERSION,
  ERROR_WRONG_UI5VERSION,
  VARIANT_MANAGEMENT_VSCODE_CONFIGURATION_COMMAND,
  NO_HELP_MARKDOWN_FOUND,
  UNKNOWN_ADD_SUBCOMMAND,
  CONTROL_PROPERTY_EDITOR_UNSUPPORTED_FE_VERSION,
  CONTROL_PROPERTY_EDITOR_MIN_UI5_VERSION,
  CONTROL_PROPERTY_EDITOR_VSCODE_CONFIGURATION_COMMAND,
  UI5_VERSION_SOURCE,
  FLP_EMBEDDED_NO_DIST,
  WARN_TARGET_SYSTEM_UI5_VERSION,
  TARGET_SYSTEM_UI5_VERSION,
  PREV_DEPLOY_DIFFERENT_APP_ID,
  REQUIRE_OVERWRITE_DEPLOY,
  ERROR_READING_MANIFEST_JSON
};
